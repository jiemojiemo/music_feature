...
double Feature::calcWindowSpectralHPS(vector<double> windowVec) {
	...
	double* coeffs2 = new double[static_cast<int>(windowSize_ / 2.0)];
	double* coeffs3 = new double[static_cast<int>(windowSize_ / 2.0)];
	double* product = new double[static_cast<int>(windowSize_ / 2.0)];
...
vector<double> Feature::calcWindowMFCC(vector<double> windowVec) {
	...
	double* fbtemp = new double[numMelFilters + 2];
	...
	double* f = new double[numMelFilters];
...
vector<double> Feature::calcWindowBark(vector<double> windowVec) {
	...
	int* band_limits = new int[numBarkBands];
